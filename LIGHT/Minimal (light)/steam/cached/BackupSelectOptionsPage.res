"steam/cached/BackupSelectOptionsPage.res"
{
	layout
	{
		...
		place { start=Label2 control=ArchiveName y=6 margin-left=9 margin-right=10 width=max dir=down }
		place { start=ArchiveName control=Label1 y=6 x=-9 height=24 dir=down }
		...
		place { start=Label4 control=Label3 x=20 y=12 }
	}
}